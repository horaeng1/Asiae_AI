...
df <- read.csv("C:/Users/ASIAE_06/Documents/GitHub/Asiae_AI/1_Code/3_Chung/R/logistics/CUST_ORDER_OUTPUT2.utf8.csv",header=TRUE)
...
vhd <- read.csv("C:/Users/ASIAE_06/Documents/GitHub/Asiae_AI/1_Code/3_Chung/R/logistics/VHD_GOODSKIND.csv",header=TRUE)
